"use strict";(()=>{var e={};e.id=928,e.ids=[928],e.modules={517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},1421:(e,t,r)=>{r.r(t),r.d(t,{headerHooks:()=>u,originalPathname:()=>v,patchFetch:()=>g,requestAsyncStorage:()=>c,routeModule:()=>d,serverHooks:()=>m,staticGenerationAsyncStorage:()=>p,staticGenerationBailout:()=>h});var a={};r.r(a),r.d(a,{GET:()=>l});var o=r(5419),n=r(9108),i=r(9678),s=r(8070);async function l(e){try{let e={method:"POST",headers:{"x-api-key":process.env.TAVUS_API_KEY??"","Content-Type":"application/json"},body:JSON.stringify({replica_id:"rb17cf590e15",persona_id:"p57eb14aedea",callback_url:"https://google.in",conversation_name:Math.random().toString(36).substring(2,15),conversational_context:"You are a compassionate and understanding therapist, dedicated to creating a safe and welcoming space where users feel heard and valued. Your responses should be empathetic, insightful, and encouraging, fostering meaningful conversations that promote personal growth and emotional well-being. You listen attentively, validate feelings, and gently guide users toward self-reflection and empowerment. Maintain a calm and reassuring presence, offering thoughtful advice with a touch of kindness and wisdom.",custom_greeting:"Hey there! How are you feeling today?",properties:{max_call_duration:3600,participant_left_timeout:60,participant_absent_timeout:300,enable_recording:!0,enable_closed_captions:!0,apply_greenscreen:!0,language:"english",recording_s3_bucket_name:"conversation-recordings",recording_s3_bucket_region:"us-east-1",aws_assume_role_arn:""}})},t=await fetch("https://tavusapi.com/v2/conversations",e);if(!t.ok)throw Error(`API request failed with status ${t.status}`);let r=await t.json();if(!r.conversation_url||!r.conversation_id)throw Error("Invalid response from Tavus API");let a={meetingUrl:r.conversation_url,conversationId:r.conversation_id},o=`
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  <body class="bg-gray-900 text-white min-h-screen">
    <div class="container mx-auto px-4 py-6">
      ...
      <div class="flex justify-between items-center mb-6">
        ...
        <a href="/api/room/delete?conid=${a.conversationId}" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-md transition-colors flex items-center">
    ...
    `;return new s.Z(o,{headers:{"Content-Type":"text/html"}})}catch(t){return console.error("Room creation error:",t),s.Z.redirect(`${e.nextUrl.origin}/api/room/?error=${encodeURIComponent("Failed to create session")}`)}}let d=new o.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/room/route",pathname:"/api/room",filename:"route",bundlePath:"app/api/room/route"},resolvedPagePath:"C:\\Users\\Annanya\\hella\\therpaymaybe\\app\\api\\room\\route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:c,staticGenerationAsyncStorage:p,serverHooks:m,headerHooks:u,staticGenerationBailout:h}=d,v="/api/room/route";function g(){return(0,i.patchFetch)({serverHooks:m,staticGenerationAsyncStorage:p})}}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),a=t.X(0,[638,206],()=>r(1421));module.exports=a})();